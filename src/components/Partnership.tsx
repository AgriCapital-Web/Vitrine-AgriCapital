      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 max-w-3xl mx-auto">
          ...
          <Card className="bg-primary/10 border-primary">
            <CardContent className="p-8">
              <div className="flex flex-col items-center">
                <div className="bg-white rounded-2xl p-6 shadow-medium max-w-md mb-4">
                  <img
                    src={lesPalmistesLogo}
          ...
          <p className="text-center text-muted-foreground mt-4">
            {t.partnership.otherPartnerships || "D'autres partenariats techniques et institutionnels sont en cours de structuration."}
          </p>
        </div>
